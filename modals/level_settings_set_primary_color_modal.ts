...
export default {
  ...
  async execute(interaction: ModalSubmitInteraction) {
    const color = interaction.fields.getTextInputValue('level_settings_set_primary_color_modal_color');
    const trans = interaction.fields.getTextInputValue('level_settings_set_primary_color_modal_trans');
    ...
    level_settings.primary_color = final_color;
    level_settings.primary_color_trans = final_trans;
