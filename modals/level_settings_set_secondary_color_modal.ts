...
export default {
    ...
    async execute(interaction: ModalSubmitInteraction) {
      try {
        const color = interaction.fields.getTextInputValue('level_settings_set_secondary_color_modal_color');
        const trans = interaction.fields.getTextInputValue('level_settings_set_secondary_color_modal_trans');
