...
export default {
  data: "level_settings_set_text_color_modal",
  async execute(interaction: ModalSubmitInteraction) {
    const color = interaction.fields.getTextInputValue('level_settings_set_text_color_modal_color');
    const trans = interaction.fields.getTextInputValue('level_settings_set_text_color_modal_trans');
    ...
    level_settings.text_color = finle_color;
    level_settings.text_color_trans = finle_trans;
