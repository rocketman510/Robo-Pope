...
export default {
  data: "level_settings_set_primary_color",
  async execute(interaction: ButtonInteraction) {
    ...
    const modal = new ModalBuilder()
      .setCustomId('level_settings_set_primary_color_modal')
      .setTitle("Primary Color");

    const color = new TextInputBuilder()
      .setCustomId('level_settings_set_primary_color_modal_color')
    ...
    const trans = new TextInputBuilder()
      .setCustomId('level_settings_set_primary_color_modal_trans')
      .setStyle(TextInputStyle.Short)
